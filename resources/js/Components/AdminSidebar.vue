    ...
    <template>
      <aside class="w-72 ">
        ...
        <div class="hidden md:block">
          <div
            class="w-full h-screen sticky top-0 bg-white border-r border-slate-200/70"
          >
            <!-- Brand -->
              ...
              <div class="space-y-1">
                ...
                >
                  ...
                  <span
                    ...
                    class="absolute right-3 h-1.5 w-1.5 rounded-full bg-white/80"
                    aria-hidden="true"
                  />
                </Link>
              </div>
        ...
        <div class="md:hidden border-b border-slate-200 bg-white">
          <div class="px-4 py-4 flex items-center justify-between">
            <div class="flex items-center gap-3">
              <div
                class="h-9 w-9 rounded-xl border border-slate-200 bg-slate-50 flex items-center justify-center"
                aria-hidden="true"
              >
          ...
          <div class="px-2 pb-3">
            <div class="grid grid-cols-2 gap-2">
              <Link
                ...
                :key="item.routeName"
                :href="item.href"
                class="flex items-center gap-2 rounded-xl px-3 py-2.5 text-sm font-medium transition border"
                :class="isActive(item.routeName)
              ...
              >
                <span
                  ...
                  :class="isActive(item.routeName) ? 'bg-white' : 'bg-slate-400'"
                  aria-hidden="true"
                />
