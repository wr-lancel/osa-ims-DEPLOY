                        ...
                        <div>
                            ...
                            <div class="mt-1 relative rounded-md shadow-sm">
                                ...
                                <button type="button" @click="togglePasswordVisibility"
                                    ...
                                    <svg v-if="!showPassword" class="h-5 w-5 text-gray-400 dark:text-gray-500 dark:text-gray-400 hover:text-gray-500 dark:text-gray-400 dark:text-gray-400"
                                    ...
                                    <svg v-else class="h-5 w-5 text-gray-400 dark:text-gray-500 dark:text-gray-400 hover:text-gray-500 dark:text-gray-400 dark:text-gray-400" fill="none"
