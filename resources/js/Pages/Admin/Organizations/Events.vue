                ...
                >
                    <div class="flex items-center justify-between">
                        <div class="flex-1 flex justify-between sm:hidden">
                            <a
                                v-if="events.links[0].url"
                                :href="events.links[0].url"
                                class="relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50"
                            >
                                Previous
                            </a>
                            <a
                                v-if="events.links[events.links.length - 1].url"
                                :href="events.links[events.links.length - 1].url"
                        ...
                        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                            <div>
                                <p class="text-sm text-gray-700">
                                    Showing
                                    <span class="font-medium">{{ events.meta.from || 0 }}</span>
                                    to
                                    <span class="font-medium">{{ events.meta.to || 0 }}</span>
                                    of
                                    <span class="font-medium">{{ events.meta.total || 0 }}</span>
                                    results
                                </p>
                            </div>
                            <div>
