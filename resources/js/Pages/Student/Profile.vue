        ...
        <form v-else @submit.prevent="submit" class="space-y-6">
                ...
                <div class="p-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-900 dark:text-white">
                                    ...
                                    <span v-if="enrollmentHistory[0]?.course_code" class="text-gray-500 dark:text-gray-400 dark:text-gray-400">({{
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm text-gray-900 dark:text-white">{{ enrollmentHistory[0]?.year_level || 'N/A' }}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-900 dark:text-white font-medium border-b border-gray-300 dark:border-gray-600 pb-1">{{
                                student.last_name
                                }}</p>
                        </div>
                        <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            <label for="phone" class="block text-xs font-medium text-gray-500 dark:text-gray-400 dark:text-gray-400 uppercase">Mobile
                                Number</label>
                        ...
                        <div>
                            <label for="email" class="block text-xs font-medium text-gray-500 dark:text-gray-400 dark:text-gray-400 uppercase">Email
                                Address</label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            <label for="birth_date" class="block text-xs font-medium text-gray-500 dark:text-gray-400 dark:text-gray-400 uppercase">Birth
                                Date</label>
                            <input id="birth_date" v-model="form.birth_date" type="date"
                                class="mt-1 block w-full border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm dark:bg-gray-700 dark:text-gray-100" />
                            <p v-if="form.errors.birth_date" class="mt-1 text-xs text-red-600 dark:text-red-400">{{ form.errors.birth_date
                                }}</p>
                        </div>
                        <div>
                            <label for="birth_place" class="block text-xs font-medium text-gray-500 dark:text-gray-400 dark:text-gray-400 uppercase">Birth
                                Place</label>
                            <input id="birth_place" v-model="form.birth_place" type="text"
                                class="mt-1 block w-full border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm dark:bg-gray-700 dark:text-gray-100"
                                placeholder="e.g. Tarlac City, Tarlac" />
                            <p v-if="form.errors.birth_place" class="mt-1 text-xs text-red-600 dark:text-red-400">{{
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                        ...
                        <div>
                            <label for="gender" class="block text-xs font-medium text-gray-500 dark:text-gray-400 dark:text-gray-400 uppercase">Gender</label>
                            ...
                            <p v-if="form.errors.gender" class="mt-1 text-xs text-red-600 dark:text-red-400">{{ form.errors.gender }}</p>
                        </div>
                        <div>
                            <label for="citizenship"
                                class="block text-xs font-medium text-gray-500 dark:text-gray-400 dark:text-gray-400 uppercase">Citizenship</label>
                            <input id="citizenship" v-model="form.citizenship" type="text"
                                class="mt-1 block w-full border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm dark:bg-gray-700 dark:text-gray-100"
                                placeholder="e.g. Filipino" />
                            <p v-if="form.errors.citizenship" class="mt-1 text-xs text-red-600 dark:text-red-400">{{
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            <label for="civil_status" class="block text-xs font-medium text-gray-500 dark:text-gray-400 dark:text-gray-400 uppercase">Civil
                                Status</label>
                            ...
                            <p v-if="form.errors.civil_status" class="mt-1 text-xs text-red-600 dark:text-red-400">{{
                                form.errors.civil_status }}
                            </p>
                        </div>
                        <div v-if="form.civil_status === 'married'">
                            <label for="spouse_name" class="block text-xs font-medium text-gray-500 dark:text-gray-400 dark:text-gray-400 uppercase">Name of
                                Spouse</label>
                            <input id="spouse_name" v-model="form.spouse_name" type="text"
                                class="mt-1 block w-full border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm dark:bg-gray-700 dark:text-gray-100"
                                placeholder="Enter spouse name" />
                            <p v-if="form.errors.spouse_name" class="mt-1 text-xs text-red-600 dark:text-red-400">{{
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
                        <div>
                            <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 dark:text-gray-400 uppercase mb-2">Single Parent?</label>
                        ...
                        <div>
                            <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 dark:text-gray-400 uppercase mb-2">With
                                Disability?</label>
                            <div class="flex items-center space-x-4">
                                <label class="inline-flex items-center">
                        ...
                        <div>
                            <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 dark:text-gray-400 uppercase mb-2">Employed?</label>
                            <div class="flex items-center space-x-4">
                                <label class="inline-flex items-center">
                    ...
                    <div v-if="form.has_disability" class="mb-4">
                        <label for="disability_details"
                            class="block text-xs font-medium text-gray-500 dark:text-gray-400 dark:text-gray-400 uppercase">Disability
                            Details</label>
                    ...
                    <div v-if="form.is_employed" class="mb-4">
                        <label for="company_name" class="block text-xs font-medium text-gray-500 dark:text-gray-400 dark:text-gray-400 uppercase">Company
                            Name</label>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label for="elementary_graduated"
                                class="block text-xs font-medium text-gray-500 dark:text-gray-400 dark:text-gray-400 uppercase">Date
                                Graduated</label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label for="senior_high_strand"
                                class="block text-xs font-medium text-gray-500 dark:text-gray-400 dark:text-gray-400 uppercase">Strand</label>
                    ...
                    <div>
                        <label for="honors_received" class="block text-xs font-medium text-gray-500 dark:text-gray-400 dark:text-gray-400 uppercase">Honors
                            Received,
                            If Any</label>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 dark:text-gray-400 uppercase mb-1">Father's Name</label>
                        ...
                        <div>
                            <label for="father_occupation"
                                class="block text-xs font-medium text-gray-500 dark:text-gray-400 dark:text-gray-400 uppercase">Occupation/Trabajo</label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 dark:text-gray-400 uppercase mb-1">Mother's Maiden
                                Name</label>
                            <div class="grid grid-cols-3 gap-2">
                                <div>
                                    <span class="text-xs text-gray-400 dark:text-gray-500 dark:text-gray-400">(Last Name)</span>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label for="contact_name"
                                class="block text-xs font-medium text-gray-500 dark:text-gray-400 dark:text-gray-400 uppercase">Name</label>
                        ...
                        <div>
                            <label for="relationship"
                                class="block text-xs font-medium text-gray-500 dark:text-gray-400 dark:text-gray-400 uppercase">Relationship</label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <label for="contact_number"
                                class="block text-xs font-medium text-gray-500 dark:text-gray-400 dark:text-gray-400 uppercase">Contact
                                Number</label>
