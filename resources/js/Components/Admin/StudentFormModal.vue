            ...
            <form @submit.prevent="submit">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <TextInput id="student_number" v-model="form.student_number" type="text"
                            class="mt-1 block w-full" :class="{ 'border-red-500': form.errors.student_number }"
                            required />
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            ...
                            <TextInput id="first_name" v-model="form.first_name" type="text" class="mt-1 block w-full"
                                :class="{ 'border-red-500': form.errors.first_name }" required />
                        ...
                        <div>
                            ...
                            <TextInput id="last_name" v-model="form.last_name" type="text" class="mt-1 block w-full"
                                :class="{ 'border-red-500': form.errors.last_name }" required />
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <TextInput id="section" v-model="form.section" type="text" class="mt-1 block w-full"
                                :class="{ 'border-red-500': form.errors.section }" placeholder="e.g. A, B, C" />
